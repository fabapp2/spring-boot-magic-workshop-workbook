...
. ✅ Start the app: You should see _LoggerGreetingService: Hola SpringIO Barcelona_.

. Remove the `{slf4j}` Maven dependency again:

. ✅ Start the app: You should now see _StdOutGreetingService: Hola SpringIO Barcelona_.
