...
. ✅ Start the application. It should now print _LoggerGreetingService: Gude SpringIO Barcelona_ or _StdOutGreetingService: Gude SpringIO Barcelona_.
...
. In the `{auto-config}` annotate `GreetingAutoConfiguration` with:
+
[source,java]
----
...
. ✅ You should see _LoggerGreetingService: Gude SpringIO Barcelona_ or _StdOutGreetingService: Gude SpringIO Barcelona_ now.
...
. ✅ Start the application. It should now print _StdOutGreetingService: Gude SpringIO Barcelona_.

. Change `workshop.greeting.type` to `logger`.

. ✅ Start the application. It should now print _LoggerGreetingService: Gude SpringIO Barcelona_.
...
. ✅ You should see: _StdOutGreetingService: Gude SpringIO Barcelona_
